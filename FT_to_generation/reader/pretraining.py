...
class ErnieDataReader(object):
    ...
    def parse_line(self, line, max_seq_len=512):
        ...
        label = int(label)
        if len(token_ids) > max_seq_len-1 and label==0:
            return [token_ids[:max_seq_len-1], sent_ids[:max_seq_len-1], pos_ids[:max_seq_len-1], label, seg_labels[:max_seq_len-1]]
        elif len(token_ids) > max_seq_len:
            return [token_ids[:max_seq_len], sent_ids[:max_seq_len], pos_ids[:max_seq_len], label, seg_labels[:max_seq_len]]
