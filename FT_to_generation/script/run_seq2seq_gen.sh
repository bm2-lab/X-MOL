...
python -u ./finetune_launch_local.py ${distributed_args} \
    ./run_seq2seq_gen.py --use_cuda true \
                   --do_train $do_train \
                   --do_val $do_val \
                   --do_test $do_test \
                   ...
                   --decoding_strategy ${decoding_strategy:-"beam_search"} \
                   --mask_prob $mask_prob \
                   ...
                   --do_dec $do_dec \
                   --beam_size $beam_size  \
                   --length_average ${length_average:-"false"} \
