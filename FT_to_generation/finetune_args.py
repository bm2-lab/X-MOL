...
model_g.add_arg("pos_emb_size",           int,  512,  "pos_emb_size")
...
train_g.add_arg("eos_idx",      int,  2,        "for seq2seq task.")
train_g.add_arg("mask_idx",     int,  3,        "for seq2seq task.")
train_g.add_arg("beam_size",    int,  4,        "for seq2seq task.")
train_g.add_arg("do_dec",       bool,   False,  "for seq2seq task.")
train_g.add_arg("mask_prob",    float,  0.7,    "mask prob")
train_g.add_arg("label_smooth", float,  None,   "label smooth")
train_g.add_arg("two_stream",   bool,   False,  "use two stream")
train_g.add_arg("random_noise", bool,   False,  "noise is random")
train_g.add_arg("decoding_strategy",    str,    "beam_search", "the decoding strategy")
train_g.add_arg("topk",         int,    20,     "the decoding strategy")
train_g.add_arg("num_samples",  int,    20,     "the number of sampling")
train_g.add_arg("temperature",  float,  1.0,    "the temperature of sampling, scale before softmax")
train_g.add_arg("T",  float,  -1.0,    "another temperature of sampling, scale after softmax")
...
data_g.add_arg("length_average",            bool,  False,  "length_average")
