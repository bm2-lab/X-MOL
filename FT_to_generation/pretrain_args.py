...
train_g.add_arg("validation_steps",  int,    20000,    "The steps interval to evaluate model performance.")
...
run_type_g.add_arg("is_unidirectional", bool,   False,  "If set, start pre-training unidirectional(left-to-right)" 
        " language model like GPT. Default is masked language model.")
